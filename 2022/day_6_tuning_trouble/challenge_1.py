...
received yet to find the marker. The first time a marker could occur is after the fourth character is received, making the most recent four characters mjqj. Because j is repeated, this isn't a marker.
...
while True:
    ...
    text = first_line[counter : counter + 4]
    is_repet = set(text)
...
print("first marker index", counter + 4)  # 1210
