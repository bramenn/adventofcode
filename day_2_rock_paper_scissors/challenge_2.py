...
# sum of your scores for each round. The score for a single round is the score for the shape you selected (1 for Rock, 2 for Paper, and 3 for Scissors) plus the score for the outcome of the round (0 if you lost, 3 if the round was a draw, and 6 if you won).
...
# def hand_result(hand_1: str,  order: str)-> int:

#     _hand_1 = data_hand_1[hand_1]
...
#     player_1_hand, player_2_hand = line.split(" ")
#     player_counter += hand_result(player_1_hand, player_2_hand)



# print("player_2_counter -> ", player_counter)
